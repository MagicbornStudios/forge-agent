...
export function WorkspaceLayoutGrid({
  ...
  const mainElement =
    React.isValidElement(main) && main.type === WorkspaceMain ? main : <WorkspaceMain>{main}</WorkspaceMain>;
  const mainChildren =
    React.isValidElement(mainElement) && 'props' in mainElement ? mainElement.props.children : null;
