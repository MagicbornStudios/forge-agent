...
- **First editor** — Built with [EditorShell](components/showcase/molecules.mdx#editorshell), [EditorDockLayout](components/showcase/molecules.mdx#editordocklayout)
...
## Step 1: Molecules — EditorShell, EditorDockLayout [#step-1-molecules]

Compose atoms into [EditorShell](components/showcase/molecules.mdx#editorshell), [EditorDockLayout](components/showcase/molecules.mdx#editordocklayout), [EditorToolbar](components/showcase/molecules.mdx#editortoolbar), and [PanelTabs](components/showcase/molecules.mdx#paneltabs). See [how-to 02 — Editor shell](how-to/02-editor-shell.mdx) and [how-to 05 — Building an editor](how-to/05-building-an-editor.mdx).

## Step 2: Organisms — Full editors

[DialogueEditor](components/showcase/organisms.mdx) and [CharacterEditor](components/showcase/organisms.mdx) are full organisms: EditorShell + DockLayout + domain-specific content. Reference: `apps/studio/components/editors/DialogueEditor.tsx`, `apps/studio/components/editors/CharacterEditor.tsx`.
...
Use [EditorShell](components/showcase/molecules.mdx#editorshell) and [EditorDockLayout](components/showcase/molecules.mdx#editordocklayout). See [how-to 05](how-to/05-building-an-editor) for the full walkthrough.
...
export function MyEditor() {
  return (
    <EditorShell editorId="my-editor" title="My Editor" domain="my-domain" className="bg-canvas">
      <EditorToolbar>
        <EditorToolbar.Left>
      ...
      <EditorDockLayout layoutId="my-editor-layout" leftDefaultSize={20}>
...
- **[EditorToolbar](components/showcase/molecules.mdx#editortoolbar)** — `.Left`, `.Center`, `.Right`, `.Menubar`, `.Button`
- **[EditorDockPanel](components/showcase/molecules.mdx#editordockpanel)** — `panelId`, `title`, `scrollable`, `locked`
...
<EditorDockPanel
  ...
  title="Chat"
  tabs={[
    { id: 'inspector', label: 'Inspector', content: <EditorInspector ... /> },
...
<EditorShell theme={theme} density={density} ... />
```
...
- [EditorShell](components/showcase/molecules.mdx#editorshell)
- [EditorDockLayout](components/showcase/molecules.mdx#editordocklayout)
