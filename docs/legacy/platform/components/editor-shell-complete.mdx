---
title: EditorShell Complete Reference
created: 2026-02-11
updated: 2026-02-11
---

# EditorShell Complete Reference
    ...
    >
      <EditorToolbar className="bg-sidebar border-b border-sidebar-border">
        ...
        <EditorToolbar.Right>
          ...
          <EditorToolbar.Button onClick={() => openOverlay('create-character')}>
            Add Character
...
- [EditorToolbar](./editor-toolbar-complete.mdx) — Toolbar with menubar, buttons, separators
