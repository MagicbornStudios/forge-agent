---
title: Unified workspace (App Shell) architecture
created: 2026-02-04
updated: 2026-02-05
---
...
- App layout primitives: `packages/shared/src/shared/components/app/*` (AppLayout, AppTabGroup, AppTab, AppContent). `AppSpace` is the semantic wrapper used by AppShell.
...
- [Workspace & editor architecture](./02-workspace-editor-architecture.mdx)
