...
Single source of truth for how the AI sidebar, context, actions, and runtime work. See also [ai-workspace-integration.md](../ai-workspace-integration.md) and [unified-workspace.md](./unified-workspace.md).
...
- **Co-agents**: Documented in [co-agents-and-multi-agent.md](../co-agents-and-multi-agent.md); not used in the app yet.
