---
title: 08 - Adding AI to workspaces
...
4. **References:** Forge = [packages/domain-forge/src/copilot](../../packages/domain-forge/src/copilot), Video = [apps/studio/lib/domains/video/copilot](../../apps/studio/lib/domains/video/copilot).
...
- **Adding another agent** (e.g. co-agent per workspace): see [17-co-agents-and-multi-agent.mdx](../17-co-agents-and-multi-agent.mdx). No code changes in this guide.
