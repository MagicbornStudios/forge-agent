...
Numbered guides that build a workspace from the ground up. Read in order; each states **what the AI can do at that stage** and points to real code.
...
- [Architecture: CopilotKit and agents](../architecture/copilotkit-and-agents.md)
