...
- **Molecules/organisms for product:** `packages/shared` (e.g. EditorShell) - published; **apps/studio** - internal-only (DialogueEditor, VideoEditor, AppShell, etc.), not shipped.
