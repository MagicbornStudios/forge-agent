...
- **Atomic design**: atoms live in `components/ui/*` (shadcn). Build molecules and organisms from those primitives.

## UI rules

- Prefer semantic tokens (`--background`, `--foreground`, `--border`) from `src/shared/styles/themes.css`.
