...
- Panel-edge hover glow and layout tab active state use `--context-accent` and `--context-glow`; resizable panel separators can be themed when inside `[data-domain]` if needed.
