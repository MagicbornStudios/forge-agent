        ...
        tabs={[
          {
            ...
            accentMutedColor: 'color-mix(in oklab, var(--status-info) 40%, transparent)',
          },
          {
            id: 'storylets',
            label: 'Storylets',
            ...
            accentMutedColor: 'color-mix(in oklab, var(--graph-edge-choice-1) 40%, transparent)',
          },
          {
            id: 'nodes',
            label: 'Nodes',
            ...
            accentMutedColor: 'color-mix(in oklab, var(--status-warning) 40%, transparent)',
          },
        ]}
      />
  );
