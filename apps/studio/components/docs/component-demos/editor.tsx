...
function EditorOverlaySurfaceDemo() {
  ...
  const [activeOverlay, setActiveOverlay] =
    React.useState<React.ComponentProps<typeof Editor.EditorOverlaySurface>['activeOverlay']>(
      { id: 'overlay-demo', payload: {} },
    );
  ...
  const openOverlay = React.useCallback(() => {
    setActiveOverlay({ id: 'overlay-demo', payload: {} });
  }, []);
...
const EDITOR_DEMOS: Record<EditorDemoId, DemoRenderer> = {
  ...
  'editor.dock-panel': () => (
    <EditorDemoHarness>
      ...
      >
        <Editor.EditorDockPanel.Tab id="content" label="Content">
          <div className="space-y-2 text-xs text-muted-foreground">
            <p>Panel header, body, and action region.</p>
            <p>Used in docked rails and tab stacks.</p>
          </div>
        </Editor.EditorDockPanel.Tab>
        <Editor.EditorDockPanel.Tab id="about" label="About">
          <div className="p-3 text-xs text-muted-foreground">Declarative tab via EditorDockPanel.Tab</div>
        </Editor.EditorDockPanel.Tab>
      </Editor.EditorDockPanel>
    </EditorDemoHarness>
  ),
  ...
  'editor.editor-overlay-surface': EditorOverlaySurfaceDemo,
  'editor.editor-panel': () => (
    <ComponentDemoFrame>
  ...
  'editor.panel-tabs': () => (
    <ComponentDemoFrame>
      <div className="h-[220px] rounded-md border border-border/70">
        <Editor.PanelTabs>
          <Editor.PanelTabs.Tab id="overview" label="Overview">
            <div className="p-3 text-xs text-muted-foreground">Overview content</div>
          </Editor.PanelTabs.Tab>
          <Editor.PanelTabs.Tab id="details" label="Details">
            <div className="p-3 text-xs text-muted-foreground">Details content</div>
          </Editor.PanelTabs.Tab>
        </Editor.PanelTabs>
      </div>
    </ComponentDemoFrame>
