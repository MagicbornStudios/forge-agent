...
const Lazy_codebase_agent_strategy_editor = React.lazy(() =>
  import('./default/example/codebase-agent-strategy-editor').then((m) => ({ default: m.CodebaseAgentStrategyEditorExample ?? m.default }))
);
