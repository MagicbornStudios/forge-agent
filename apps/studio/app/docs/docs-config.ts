...
export const DOC_ENTRIES = [
  ...
  { slug: '05-building-a-workspace', label: '05 - Building an editor mode' },
  { slug: '06-forge-workspace-walkthrough', label: '06 - DialogueMode walkthrough' },
  { slug: '07-copilot', label: '07 - Copilot and AI integration' },
  { slug: '08-adding-ai-to-workspaces', label: '08 - Adding AI to modes' },
  { slug: '09-twick-workspace', label: '09 - VideoMode walkthrough' },
  { slug: '20-create-a-workspace', label: '20 - Create an editor mode' },
