...
const DialogueWorkspace = lazy(() => import('@/components/editors/DialogueWorkspace'));
const CharacterWorkspace = lazy(() => import('@/components/editors/CharacterWorkspace'));

function App() {
  return (
    <Suspense fallback={<EditorLoadingSkeleton />}>
      <Router>
        <Route path="/dialogue" element={<DialogueWorkspace />} />
        <Route path="/character" element={<CharacterWorkspace />} />
      </Router>
    </Suspense>
  );
}
