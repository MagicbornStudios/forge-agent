export const ROADMAP_MVP_SUMMARY = {
  ...
  platform: 'Platform app (landing + customer platform)',
  heroMoments: [
...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  },
  {
    ...
    status: 'planned',
    statusLabel: 'Planned',
    description: 'Export/import .yarn files, Yarn syntax preview, variable panel, command palette.',
    impact: 'Medium',
  },
  {
    id: 'yarn-full',
  ...
  },
  {
    ...
    statusLabel: 'Planned',
    description:
      'Authors publish builds; we host playable narratives. Build pipeline, storage, playable runtime.',
    impact: 'Large',
  },
  {
    id: 'monetization',
  ...
  },
  {
    ...
    statusLabel: 'Shipped',
    description:
      'Landing page, docs, login, account and billing, waitlist and newsletter, roadmap and changelog pages, pricing.',
  },
  {
