...
Sign up or log in from the [marketing site](/) or the [Log in](/login) page. Your account is shared across the marketing site and the app.
...
See [Features](/docs/features) for more detail, or join the [waitlist](/waitlist) for early access and updates.
