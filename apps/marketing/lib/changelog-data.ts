/**
 * Changelog entries. Seeded from STATUS "What changed" / Ralph Wiggum Done.
 * Format: date (YYYY-MM-DD), optional version, and highlights.
 */
...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Marketing site: apps/marketing with landing, docs, login, account, billing, waitlist.',
    ],
  },
  {
    date: '2026-02-04',
