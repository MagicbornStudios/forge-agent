...
Use slots for flexible composition without prop drilling. `EditorDockLayout` exposes `.Left`, `.Main`, `.Right`, `.Bottom` and `EditorDockLayout.Panel`.
...
<!-- AGENT_SECTION -->
File refs: `packages/shared/`, `EditorDockLayout`, `FeatureGate`
