...
must_haves:
  ...
  artifacts:
    - path: ".planning/phases/01-forge-loop-bootstrap/01-01-SUMMARY.md"
      provides: "Execution summary for plan 01"
      min_lines: 10
  key_links:
    - from: ".planning/ROADMAP.md"
      to: ".planning/phases/01-forge-loop-bootstrap/01-01-SUMMARY.md"
      via: "plan-to-summary traceability"
---

<objective>
Implement phase 01 deliverables for Forge Loop bootstrap.
</objective>
