...
must_haves:
  ...
  artifacts:
    - path: ".planning/phases/13-ai-runtimes-correction-and-database-workspace/13-02-SUMMARY.md"
      provides: "Execution summary for plan 02"
      min_lines: 10
  key_links:
    - from: ".planning/ROADMAP.md"
      to: ".planning/phases/13-ai-runtimes-correction-and-database-workspace/13-02-SUMMARY.md"
