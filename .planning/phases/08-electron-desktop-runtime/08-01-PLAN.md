...
must_haves:
  truths:
    - "Electron runtime shell must align to analysis contracts in .planning/ANALYSIS-REFERENCES.md."
    - "Outputs must keep Forge Loop artifacts traceable and deterministic for repeat runs."
  artifacts:
    - path: ".planning/phases/08-electron-desktop-runtime/08-01-SUMMARY.md"
      provides: "Electron runtime shell execution summary."
      min_lines: 10
  key_links:
...
<objective>
Create Electron shell/runtime startup contracts for RepoStudio desktop operation.
</objective>
...
<tasks>
<task type="auto">
  <name>Implement Electron runtime shell</name>
