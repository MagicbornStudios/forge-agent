...
must_haves:
  truths:
    - "Publish preview review integration must align to analysis contracts in .planning/ANALYSIS-REFERENCES.md."
    - "Outputs must keep Forge Loop artifacts traceable and deterministic for repeat runs."
  artifacts:
    - path: ".planning/phases/07-structured-parsers-and-story-publish-pipeline/07-04-SUMMARY.md"
      provides: "Publish preview review integration execution summary."
      min_lines: 10
  key_links:
...
<objective>
Integrate story publish previews into existing diff/review queue flows before apply.
</objective>
...
<tasks>
<task type="auto">
  <name>Implement Publish preview review integration</name>
