...
import { useAIHighlight } from '@/shared/copilot/use-ai-highlight';
import { useDomainCopilot } from '@/shared/copilot/use-domain-copilot';
...
import type { OverlaySpec, ActiveOverlay, Selection } from '@/shared/workspace';
import { isEntity } from '@/shared/workspace';
import type { ForgeNodeType } from '@/types/graph';
