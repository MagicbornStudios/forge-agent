...
/**
 * WorkspacePanel — a single region within an `WorkspaceLayout`.
 *
 * Features:
 ...
 * @example
 * ```tsx
 * <WorkspacePanel panelId="inspector" title="Inspector" icon={<Settings />} scrollable>
 *   <PropertyEditor ... />
 * </WorkspacePanel>
 * ```
 *
 ...
 * ```
 */
/** Canonical workspace panel surface. */
...
WorkspacePanel.Tab = PanelTabs.Tab;
