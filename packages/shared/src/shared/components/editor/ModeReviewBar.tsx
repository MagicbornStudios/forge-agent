...
export interface ModeReviewBarProps {
...
/**
 * ModeReviewBar — a plan/commit review bar for AI-generated changes.
 *
 * Replaces `WorkspaceReviewBar`. Renders between the `ModeToolbar`
